<?php
    ...
    include "connect.php";
    $ambildata = mysqli_query($koneksi,"select * from penduduk_baru");
    ...
    <div class="jdl">
        ...
        <h4>SURAT KETERANGAN PENDUDUK</h4>
        ...
        Demikian Surat Keterangan Penduduk ini dibuat dan diberikan kepada
