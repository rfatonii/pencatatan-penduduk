...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="mutasi1.css">
...
<div class="all">
<div class="forum">
<form method="post" action="mutasisimpan.php">
    <div class="form-registrasi">

     <div class="form-penduduk">
    <div class="page1">
        <div class="header-page">
            <h2>FORM PENGAJUAN MUTASI</h2>
    ...
    <div class="form">
        ...
        <div class="contens">
            <label for="judul">
                ...
                <div class="textbox">
                    <input type="text" name="alamat" class="form-contens">
                </div>
            </label>
        </div>
        ...
        <div class="btn">
            <div class="end">
                <input type ="submit" value = "Kirim" name="kirim" class="bottom">
            </div>
        ...
        <div class ='nav-bar'>
            ...
            <div class="information-p">
                ...
                <br>
                <p>
                    form pengajuan mutasi digunakan untuk keperluan memperoleh surat pindah dari desa.
                </p>
            </div>
